...
import { ExpenseCategoryType } from "@/utils";
import "../styles/expense-entry.css";

export const ExpenseEntry = ({ data, setData, grandTotal, subAgents = [], rembursements = [] }) => {
        ...
        [
            ...
            },
            {
                ...
                render: (value, record, index) => {
                    const options = record.account_category === ExpenseCategoryType.Rembursement ? rembursements : subAgents;
            ...
            //             value={record.tid}
            //             onChange={(e) => handleInputChange (e.target.value, index, 'tid')}
            //         />
            //     )
            // },
            // {
            ...
            //                     zIndex: 1,
            //                 }}
            //                 onClick={() => handleRowAction3(index)}
            //             /> */}
            //         </div>
            //     )
            // },
        ]
    ), [rembursements, subAgents, dataSource]);

    return (
        <div className='expense-entry'>
            <Card title={'Expense'}>
                <Table className='expense-tbl' columns={columns} dataSource={dataSource} pagination={false} bordered />
            </Card>
        </div>
    )
}
